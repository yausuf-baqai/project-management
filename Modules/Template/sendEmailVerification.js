...
const sendEmailVerificationMail = function(link,weblink,brandName=''){
                                ...
                                <tr>
                                    <td align="left" valign="top" style="border-collapse:collapse!important;word-break:break-word;padding:30px 40px">
                                        ...
                                        <p style="font-size:14px;padding-bottom:20px;margin:0">
                                            Before being able to access your account you need to verify your email address by clicking here
                                        </p>
                            ...
                            <tbody>
                                <tr>
                                    <td align="center" style="border-collapse:collapse!important;word-break:break-word;color:#8d8c9f;font-size:11px;padding:0">
                                        <p style="font-size:14px;padding-bottom:10px;margin:0">Copyright 2023 © ${brandName}, All Rights Reserved.</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
