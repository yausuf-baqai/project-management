<template>
    ...
    <div v-show="tabIndexCheck === 2">
        <CustomFieldInputComponent
            ...
            :help="'Limit the minimum or maximum amount of text allowed in this field'"
        ...
        <div v-show="entryLimitsToggle && entryLimitsToggle.length" class="position-re">
            ...
            <CustomFieldInputComponent
                ...
                :preventDefault="true"
            />
            <small class="red position-ab textCustomField__error_msg" v-if="fieldMinimum && fieldMaximum && Number(fieldMinimum) > Number(fieldMaximum)">Maximum value should be greater than Minimum value.</small>
        </div>
    </div>
</template>
